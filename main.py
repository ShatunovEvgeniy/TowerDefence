...
class Board(QtWidgets.QFrame):
    ...
    def paintEvent(self, a0: QtGui.QPaintEvent) -> None:
        ...
        if self.fire_delay % 4 == 0:  # if it's fire iteration
            for enemy, archer in self.archersAttacks:
                ...
                # self.draw_rect(painter, int(x1), int(y1), arrow)
        ...
        for enemy in self.enemies:
            ...
            if coord[0] >= 20 or coord[1] >= 20:
                ...
                self.draw_rect(painter, rect.left() + x + self.tile_width() / 4 + 10, board_top + y + 10, enemy.skin,
...
class Tower:
    def __init__(self, coord, level, skins):    # skins is array of QImage
        ...
        self.force = 50 * level  # 20, 40, 60 damage
